...
conversation_id = "c36c3fe4-8d30-470f-9abf-f1fd11520501"
model = "gpt-3.5-turbo-0613"
llm= ChatGPTAPI_unsafe.ChatGPT(token=os.environ.get("CHATGPT_TOKEN"), conversation=conversation_id)
conversation_id = "c1c246d5-0d08-4897-9a74-febfceb89c18"
model = "gpt-3.5-turbo-0613"
llm2json= ChatGPTAPI_unsafe.ChatGPT(token=os.environ.get("CHATGPT_TOKEN"), conversation=conversation_id)
...
def retrieve_extraction(topic):
    docs = query_watson_discovery(topic, topk=5)
    ...
    with open('/workspace/answerfromKB/WatsonxChallenge/output/classified_news.json','w') as f:
...
with open('/workspace/answerfromKB/WatsonxChallenge/output/extracted_news.json','w') as f:
